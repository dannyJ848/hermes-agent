#!/bin/bash
# Train EAGLE-3 draft model for Qwen3.6-27B on DGX Spark
...
# Draft model config
DRAFT_CONFIG="configs/qwen3.6-27b-eagle3.json"

# Paths
DATA_PATH="cache/dataset/ultrachat_train.jsonl/ultrachat_train.jsonl"
HIDDEN_STATES_PATH="cache/hidden_states/qwen3.6-27b-ultrachat"
OUTPUT_DIR="cache/outputs/qwen3.6-27b-eagle3"
CACHE_DIR="cache"
