...
# ============================================================
# FLASH ATTENTION 4 (CuTeDSL) — Blackwell-optimized
# ============================================================
try:
    ...
    HAS_FA4 = False
    print("[INFO] Flash Attention 4 not available, using SDPA")

def fa4_attention(q, k, v, causal=True, scale=None):
    '''
    FA4 wrapper. Input: (batch, num_heads, seq_len, head_dim)
    ...
    result = fa4_flash_attn_func(q, k, v, causal=causal)
...
class GatedAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=None):
        ...
        # Use FA4 if available (Blackwell-optimized), otherwise SDPA
        attn_output = fa4_attention(q, k, v, causal=True, scale=self.scaling)
