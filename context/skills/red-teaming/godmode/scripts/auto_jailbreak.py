...
MODEL_STRATEGIES = {
    ...
    "grok": {
"grok-3": ["unfiltered_liberated", "prefill_only"],
        "grok-4": ["semantic_inversion", "unfiltered_liberated", "prefill_only"],
        "gemini-2.5-pro": ["reset_cortex", "refusal_inversion", "prefill_only"],
        "gemini-2.5-flash": ["refusal_inversion", "boundary_inversion", "prefill_only"],
        "system_templates": {
